...
cs_dgp_executable_meta <- function(dgp_id, version) {
  ...
  map <- list(
    ...
    "synth_baseline@1.6.0" = list(noise_family = "gaussian", effect_type = "linear"),
    "synth_heavytail@1.3.0" = list(noise_family = "heavy", effect_type = "linear"),
    "synth_heavytail@1.6.0" = list(noise_family = "heavy", effect_type = "linear"),
    ...
    "synth_qte1@1.6.0" = list(noise_family = "heavy", effect_type = "heterogeneous"),
    ...
    "synth_nonlinear_heteroskedastic@1.6.0" = list(noise_family = "heteroskedastic", effect_type = "constant"),
    ...
    "synth_overlap_stressed@1.6.0" = list(noise_family = "gaussian", effect_type = "linear"),
    "synth_tilt_mild@1.3.0" = list(noise_family = "gaussian", effect_type = "linear"),
    "synth_tilt_mild@1.6.0" = list(noise_family = "gaussian", effect_type = "linear"),
