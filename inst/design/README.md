...
**Current active packets:** `causalstress_v0_2_1_spec_packet` — accepted Quarto documentation and bounded-maintenance authority; ticket derivation and review are pending before implementation.
**Draft packets:** none
...
| `causalstress_v0_2_1_spec_packet/` | `ACTIVE` packet | Accepted v0.2.1 Quarto documentation and bounded-maintenance authority. Ticket derivation and independent ticket review precede implementation. |
