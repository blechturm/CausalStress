...
| `causalstress_v0_2_1_spec_packet/` | `ACTIVE` packet | Accepted v0.2.1 Quarto documentation and bounded-maintenance authority. Batches 0–4, the Batch 5 manual tag-only Pages mechanism, and two initial branch-CI corrections are complete after independent review; fresh correction CI and the final release gate remain pending. |
